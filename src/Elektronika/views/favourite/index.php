                ...
                if(!empty($offers[$i][0])){
                    ...
                    echo '<div class="row" style="padding-top: 5%;">
					            <div class="col-md-4" style=" padding: 0px;">
					            	<div class="car-thumb offer-thumb">
										...
										<div style="position: absolute;bottom: 0; width:100%;">
											<div  class="car-thumb-text offer-thumb-text" style="padding: 0; text-align: center; width: 50%; float: left;"> '. $offers[$i]["price"] .' 
											</div>

											<div class="car-thumb-type offer-thumb-type" style="padding: 0; text-align: center; width: 50%; float: right;">	 ' . $type . '
											</div>
										</div>
									</div>
								</div>	
								...
								<div class="col-md-8 search-description" style="display: block; width: 100%; background-color: #e6e6e6; padding: 0px;">
									<div class="car-thumb-text offer-thumb-text" style="padding-left: 0px; text-align: center; max-height: 33.41px;">'. $offers[$i]["title"] .'						
									</div>
